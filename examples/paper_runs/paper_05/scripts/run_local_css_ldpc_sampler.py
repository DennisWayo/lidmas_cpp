...
def main() -> int:
    ...
    for spec in experiment_specs(args.targets):
        ...
        experiments.append(
            {
                ...
                "expected_syndrome": expected_syndrome(spec.injected_x),
    ...
    payload = {
        ...
        "backend": "local_css_ldpc_sampler",
        "job_id": f"local-css-ldpc-{args.seed}",
    ...
    out_path = out_dir / "local_css_ldpc_results.json"
