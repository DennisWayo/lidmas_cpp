#!/usr/bin/env python3
"""Decode paper_05 surface-code Z-check syndrome request streams."""
...
def main() -> int:
    ...
    for req_path in sorted(in_dir.glob("decoder_requests_*.ndjson")):
        ...
        resp_paths = {
            decoder: out_dir / f"decoder_responses_{dataset}_surface_{decoder}.ndjson"
                ...
                for decoder in decoders:
                    ...
                    response = {
                        "correction": {
                            ...
                            "decoder_name": f"surface_{decoder}",
                        },
    ...
    print(f"Decoded {len(csv_rows)} surface-code syndrome-policy rows into {out_dir}")
    return 0
