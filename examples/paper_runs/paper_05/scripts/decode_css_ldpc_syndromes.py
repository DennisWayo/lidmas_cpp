...
from css_ldpc_syndrome import hz_matrix
from paper05_decoder_policies import decode_policy, parse_decoders, syndrome_from_request
...
def main() -> int:
    ...
    for req_path in sorted(in_dir.glob("decoder_requests_*.ndjson")):
        ...
        resp_paths = {
            decoder: out_dir / f"decoder_responses_{dataset}_css_ldpc_{decoder}.ndjson"
                ...
                for decoder in decoders:
                    ...
                    response = {
                        "correction": {
                            ...
                            "decoder_name": f"css_ldpc_{decoder}",
                        },
