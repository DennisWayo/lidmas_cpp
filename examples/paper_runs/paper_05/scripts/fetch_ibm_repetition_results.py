#!/usr/bin/env python3
"""Fetch a completed paper_05 IBM Runtime job into the raw-results JSON format."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--status-only", action="store_true", help="Report Runtime job status without fetching results.")
...
def main() -> int:
    ...
    print(f"Fetched IBM Runtime job {job_id}; status={status}")
    if args.status_only:
        return 0
