#!/usr/bin/env python3
"""Build paper_05 surface-code Z-check syndrome circuit artifacts."""
...
from surface_syndrome import build_qiskit_circuit, circuit_metadata, experiment_specs
...
def main() -> int:
    ...
    for spec in specs:
        circuit = build_qiskit_circuit(args.distance, spec)
        meta = circuit_metadata(args.distance, spec)
    ...
    print(f"Wrote {len(specs)} surface-code syndrome circuits to {out_dir}")
    return 0
