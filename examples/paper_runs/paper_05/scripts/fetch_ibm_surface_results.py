#!/usr/bin/env python3
"""Fetch a completed paper_05 surface-code IBM Runtime job."""
...
def main() -> int:
    ...
    print(f"Fetched IBM Runtime surface-code job {job_id}; status={status}")
    if args.status_only:
        return 0
    ...
    payload = {
        ...
        "code_family": "surface",
        "code_name": submission.get("code_name", ""),
        "distance": int(submission.get("distance", 0)),
